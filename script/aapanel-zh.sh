...
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://ghproxy.com/https://raw.githubusercontent.com/daovantrong/aaPanel/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://ghproxy.com/https://github.com/daovantrong/aaPanel/releases/download/1.3/LinuxPanel-7.7.0.zip"
blue "下载完成,正在降级."
...
wget https://ghproxy.com/https://raw.githubusercontent.com/daovantrong/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
red "开心成功."
}
...
wget -O /root/chinese.zip https://ghproxy.com/https://github.com/daovantrong/aaPanel/releases/download/1.2/aapanel_chinese-6.8.21.zip
